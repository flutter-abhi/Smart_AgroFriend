  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(  
        ...
        title: Image.asset("assets/hellokrushi.png", height: 100,width: 100,),
        actions: const  [ 
        ...
        child: SingleChildScrollView(
            ...
            child: Column(  
              ...
              children: [  
                ...
                Container( 
                  ...
                  child:  ImageSlideshow(
                    ...
                    children: [ 
                      Container(
                        color: Colors.pink,
                        child: Image.asset("assets/top1.jpeg",fit: BoxFit.cover,),
                      ),
                      Container(
                        color: Colors.yellow,
                         child:  Image.asset("assets/top1.jpeg",fit: BoxFit.cover,),
                ...
                Text("आमच्या सेवा" ,style: GoogleFonts.poppins(fontSize: 20 ,),) ,
                SizedBox(height: 10,),
                                  ...
                                  BoxShadow( 
                                   // offset: Offset(2, 2),
                                    ...
                                    color: Colors.grey
                                                             ...
                                                             child:  Image.asset(service[index]["backImage"],fit: BoxFit.cover,),
                                                             ),
                              ),
                               Container(
                                decoration: BoxDecoration( 
                                ...
                                width: MediaQuery.of(context).size.width/2.3,
                                child: Text(service[index]["serviceName"] ,textAlign: TextAlign.center ,style: const  TextStyle( fontSize: 22 , fontWeight: FontWeight.w500 , color: Colors.black),)
                                ),
